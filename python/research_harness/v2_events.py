...
class EventType:
    ...
    IDEMPOTENT_LOOKUP_ATTEMPT = "IDEMPOTENT_LOOKUP_ATTEMPT"
    IDEMPOTENT_LOOKUP_FOUND = "IDEMPOTENT_LOOKUP_FOUND"
    IDEMPOTENT_LOOKUP_NOT_FOUND = "IDEMPOTENT_LOOKUP_NOT_FOUND"
    ...
    CRASH_POINT_REACHED = "CRASH_POINT_REACHED"
    ORCHESTRATOR_KILL_REQUESTED = "ORCHESTRATOR_KILL_REQUESTED"
    ORCHESTRATOR_PROCESS_EXITED = "ORCHESTRATOR_PROCESS_EXITED"
    ORCHESTRATOR_UNAVAILABLE = "ORCHESTRATOR_UNAVAILABLE"
    ORCHESTRATOR_RESTART_REQUESTED = "ORCHESTRATOR_RESTART_REQUESTED"
    ORCHESTRATOR_RESTARTED = "ORCHESTRATOR_RESTARTED"
